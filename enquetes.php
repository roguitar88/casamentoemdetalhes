...
<meta name="keywords" content=""/>
    ...
    <![endif]-->
<title>#<?php echo $perfil['nomedeusuario']; ?> - Enquetes</title>
...
<main>
    <div class="conteudoprincipal2">
		<div class="enquetes" style="width:100%; height:auto; padding:3%; text-align: center; margin:auto;">
			<h2 class="titulodotexto" style="font-family: <?php echo $font; ?>; font-size: <?php echo $size; ?>; color: <?php echo $titlecolor; ?>;">Enquetes</h2>
			<img src="images/enquete2.jpg" width="50%" height="auto" />
			<br/><br/>
			<img src="images/enquete1.png" width="50%" height="auto" />
			<br/><br/><br/>
			<center><span style="font-size: 140%; color: royalblue; font-weight: bold;">Em breve...</span></center>
			<br/><br/>
