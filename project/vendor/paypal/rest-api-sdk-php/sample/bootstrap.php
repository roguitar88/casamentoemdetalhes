...
if (!file_exists($composerAutoload)) {
    ...
    //$composerAutoload = dirname(dirname(dirname(dirname(__DIR__)))) . '/vendor/autoload.php';   //it's the same thing
    //if (!file_exists($composerAutoload)) {
...
if($env == "SANDBOX"){
    //SANDBOX
    $clientId = 'Id-do-Cliente-PayPal';
    $clientSecret = 'Segredo-do-Cliente-PayPal';
}else{
    //LIVE
    $clientId = 'Id-do-Cliente-PayPal';
    $clientSecret = 'Segredo-do-Cliente-PayPal';
