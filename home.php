...
<meta name="keywords" content=""/>
    ...
    <![endif]-->
<title>#<?php echo $perfil['nomedeusuario']; ?> - Homepage do Casal</title>
...
<main>
    <div class="conteudoprincipal2">
		...
		<div class="texthalf">
			<h2 class="titulodotexto" style="font-family: <?php echo $font; ?>; font-size: <?php echo $size; ?>; color: <?php echo $titlecolor; ?>;">Início</h2>
			<p class="estilotexto" style="text-align: left; font-size: 100%; font-family: <?php echo $font1; ?>; color: <?php echo $textcolor; ?>;">😍 <?php echo $perfil['textoinicio']; ?> 🎶</p>
			<!--<p class="estilotexto" style="text-align: left; font-size: 100%; font-family: <?php echo $font1; ?>; color: <?php echo $textcolor; ?>;">Ah, quase ninguém vê 👀. Quanto mais o tempo passa, mais aumenta a graça em te viver.</p>-->
			<br/><br/>
